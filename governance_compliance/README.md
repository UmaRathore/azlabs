...
```
### Activity Log
![Activity Logs for Custom Roles](./images/activityLog_CustomRoles.png)
...
![Enforce tagging via an Azure Policy](./images/storage_tags_via_policy.png)
...
![Deployment Automation](./images/Templates_architecture.png)
...
```
![Deploy Resources using Powershell](./images/TemplatesUsingPowershell.png)
...
```
![Deploy a template with CLI](./images/TemplatesUsingCLI.png)
